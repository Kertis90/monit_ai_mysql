...
5. [Управление кластерами](#управление-кластерами)
6. [Чат и API](#чат-и-api)
7. [WebSocket-протокол](#websocket-протокол)
8. [Алерты](#алерты)
9. [Обновление настроек LLM](#обновление-настроек-llm)
10. [HTTPS / WSS через nginx](#https--wss-через-nginx)
