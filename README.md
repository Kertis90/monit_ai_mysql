...
6. [Переприменить все настройки](#переприменить-все-настройки)
7. [Управление кластерами](#управление-кластерами)
8. [Чат и API](#чат-и-api)
9. [WebSocket-протокол](#websocket-протокол)
10. [Алерты](#алерты)
11. [Обновление настроек LLM](#обновление-настроек-llm)
12. [HTTPS / WSS через nginx](#https--wss-через-nginx)
13. [Аутентификация](#аутентификация)
14. [Диагностика проблем](#диагностика-проблем)
