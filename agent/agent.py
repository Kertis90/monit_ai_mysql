...
# Active Directory на неудачный bind отвечает одним и тем же кодом 49, а
# настоящую причину прячет в тексте: "80090308: LdapErr ..., data 52e, ...".
# Без расшифровки просроченный пароль и отключённая учётка выглядят как
# опечатка в пароле, и админ ищет проблему не там.
AD_BIND_ERRORS = {
