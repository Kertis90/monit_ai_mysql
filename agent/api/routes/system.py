...
@router.get("/health/deep", tags=["Служебные"],
            summary="Проверка всех зависимостей агента")
async def health_deep(user: MaybeUser):
    """Prometheus, модель, SSH до каждого сервера, учётки БД, каталог.
